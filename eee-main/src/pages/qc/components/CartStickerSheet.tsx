...
function drawStickerPdfPage(
  ...
  // LW = left (QR) column width, G = gap. Narrowed so the right content block
  // sits clearly further left and gets noticeably more width.
  const P = 3, LW = 25, G = 1.5, RX = P + LW + G, RW = MM_W - RX - P;
